                    ...
                    <div class="instashow-demo-filter instashow-demo-field-group">
                        ...
                        <div class="instashow-demo-field">
                            <div class="instashow-demo-field-description">
                                <?php _e('Filter Instagram posts by setting various conditions. Include or exclude posts by using different combinations of @username, #hashtag, location or post URL.', ELFSIGHT_INSTASHOW_TEXTDOMAIN); ?>
                            </div>
